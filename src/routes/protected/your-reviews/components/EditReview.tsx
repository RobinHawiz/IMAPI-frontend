...
import { reviewEditMutationOptions } from "@hooks/queryOptions";
import {
  updateReviewSchema,
...
function EditReview({
  ...
  const handleSubmit = async (e: SubmitEvent<HTMLFormElement>) => {
    ...
    // Form submission
    try {
      const review: ReviewUpdatePayload = { ...result.data };
      await editReviewMutation(review);
  ...
  return (
    <dialog id="edit-review-modal" className="modal">
        ...
        >
          <div>
            <h2 className="text-2xl font-black md:text-3xl">
              Edit Review<span className="text-accent">.</span>
            </h2>
          ...
          <div className="flex flex-row gap-4">
            <button
              ...
              disabled={isLoading}
            >
              <img src={check} className="h-4 w-4" aria-hidden="true" />
