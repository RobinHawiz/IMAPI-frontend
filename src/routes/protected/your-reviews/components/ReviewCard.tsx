...
function ReviewCard({
  ...
  return (
    <article className="shadow-elevation-medium bg-subtle/10 border-subtle/20 hover:border-accent/20 flex min-h-52 flex-col justify-between rounded-2xl border border-solid p-6 transition-all duration-300 ease-in-out hover:-translate-y-1.5">
      <div>
